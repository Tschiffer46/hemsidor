    ...
    <section id="kontakt" className="py-20 bg-gradient-to-br from-h-teal-dark to-h-teal">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-2xl mx-auto bg-white rounded-2xl shadow-xl p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              {status === 'error' && (
                <p className="text-red-500 text-sm">
                  ...
                  <a href="mailto:thomas@agiletransition.se" className="underline">
          ...
          <div className="mt-6 pt-6 border-t border-gray-100 flex flex-col sm:flex-row items-center justify-center gap-4 text-sm text-h-mid">
            <a href="mailto:thomas@agiletransition.se" className="flex items-center gap-2 hover:text-h-teal transition-colors">
